...
``` typescript
import pkg from 'https://unpkg.com/version-range@^4.8.0/edition-deno/index.ts'
```
...
``` html
<script type="module">
    import pkg from '//cdn.skypack.dev/version-range@^4.8.0'
</script>
```
...
``` html
<script type="module">
    import pkg from '//unpkg.com/version-range@^4.8.0'
</script>
```
...
``` html
<script type="module">
    import pkg from '//dev.jspm.io/version-range@4.8.0'
</script>
```
